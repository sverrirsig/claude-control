    ...
    <header className="mb-10">
      <div className="flex items-end justify-between">
        ...
        <div className="flex items-center gap-3">
          {/* View controls group: view mode toggle + stale toggle */}
          <div className="flex items-center gap-1.5">
            ...
            {staleCount > 0 && (
              <button
                ...
                className={`has-tooltip flex items-center gap-2 px-3 h-8 rounded-lg border transition-colors titlebar-no-drag bg-zinc-900/80 border-zinc-800/50 hover:bg-zinc-800 hover:border-zinc-700 ${
                  hideStale ? "text-zinc-500 hover:text-zinc-300" : "text-zinc-400 hover:text-zinc-200"
                }`}
                data-tip={hideStale ? "Show stale sessions (S)" : "Hide stale sessions (S)"}
              >
              {hideStale ? (
